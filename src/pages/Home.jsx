                ...
                <div className="lg:w-1/2 w-full flex items-center justify-center px-6 py-20">
                    <div className="max-w-2xl space-y-8">
                        <div className="space-y-6">
                            ...
                            <motion.p
                                className="text-2xl md:text-3xl text-blue-400 font-semibold tracking-wide leading-relaxed"
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
                            ...
                            >
                                ...
                                I am enthusiastic about applying my academic knowledge and technical skills in software testing to contribute to a team focused on quality
                                and reliability. My strong analytical abilities, attention to detail, and dedication to problem-solving drive my commitment to delivering robust
                        ...
                        >
                            ...
                            <a
                                href="/contact"
                                className="border border-blue-500 text-blue-400 hover:bg-blue-500 hover:text-white px-8 py-3 rounded-lg font-semibold transition-all duration-200"
                            >
                                Get In Touch
                            </a>
                        </motion.div>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-300 text-lg leading-relaxed font-light tracking-wide">
                            Passionate about continuous learning, I thrive on solving challenges, collaborating in teams, and exploring how technology can improve people’s daily lives. My long-term goal is to become a versatile QA Engineer, bridging software development and quality assurance to deliver high-impact, reliable solutions.
                        </p>
