        ...
        >
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                ...
                >
                    <Link
                        to="/"
                        className="text-2xl font-bold text-blue-800 hover:text-blue-700 transition-all duration-300 relative group"
                ...
                {/* Mobile Menu Button */}
                <motion.button
                    className="md:hidden text-gray-300 hover:text-blue-800 transition-colors"
